...
export function FaqSection() {
  ...
  return (
    <section id="faq" className="w-full bg-zinc-900 py-24 md:py-32 border-b border-zinc-700/30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-3 px-4 py-2 border border-zinc-700 w-fit">
              ...
              <span className="text-sm font-medium text-zinc-400 tracking-wide">FAQ</span>
            </div>
            ...
            <p className="text-balance text-base md:text-lg text-zinc-400 leading-relaxed max-w-md">
              Get quick answers about Skydda's AI-powered security platform and how autonomous
              threat detection protects your organization. Can't find what you're looking for? Reach
              out below.
            </p>
          </div>
                  ...
                  {openId === faq.id && (
                    ...
                    >
                      <div className="pb-6 pr-12">
                        <p className="text-base leading-relaxed text-zinc-400">{faq.answer}</p>
                      </div>
                    </motion.div>
                  )}
                </AnimatePresence>
