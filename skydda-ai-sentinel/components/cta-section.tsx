      ...
      <div className="relative mx-auto max-w-7xl px-6 md:px-12 lg:px-16 py-24 md:py-32 lg:py-40">
        <div className="max-w-2xl">
          ...
          <p className="text-balance mt-6 max-w-xl text-base leading-relaxed text-white/80 md:text-lg">
            Experience autonomous threat detection now. Deploy the Sentinel and see how AI protects
            your gateway.
          </p>
          <Button size="lg" className="mt-8 bg-white px-8 text-black hover:bg-white/90">
            Deploy the Sentinel
          </Button>
        </div>
      </div>
