...
const plans: PricingPlan[] = [
  {
    ...
    priceMonthly: 299,
    priceYearly: 239,
    description: "Essential threat detection for growing teams and small infrastructure.",
    features: [
      "Up to 100 endpoints",
  ...
  },
  {
    ...
    priceMonthly: "Custom",
    priceYearly: "Custom",
    description: "Full Aegis Core deployment with dedicated security team and custom integrations.",
    features: [
      "Unlimited endpoints",
...
export function PricingSection() {
  ...
  return (
    <section id="pricing" className="w-full bg-zinc-900 py-24 md:py-32 border-b border-zinc-700/30">
        ...
        <div className="flex flex-col gap-10 w-full">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="bg-amber-500/10 px-3 py-1.5 border border-amber-500/20">
              <span className="text-xs font-medium text-amber-500">20% OFF</span>
            </div>
          </div>
              ...
              >
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex items-center justify-between">
                    <span className="text-xl font-normal text-white">{plan.name}</span>
                    {plan.popular && (
                      <div className="bg-amber-500/10 border border-amber-500/20 px-2.5 py-1">
                        <span className="text-xs font-medium text-amber-500">Popular</span>
                      </div>
                    )}
                  </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs text-zinc-500 shrink-0">Features</span>
                  <div className="flex-1 h-[1px] bg-zinc-700" />
                </div>
