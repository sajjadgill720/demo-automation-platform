...
import { Check, ClipboardList, FileText, MessagesSquare, Sparkles, PhoneCall } from "lucide-react";
...
export function JourneyHeader() {
  ...
  return (
    ...
    >
      ...
      {/* Full view — sm and up. */}
      <ol className="hidden sm:flex items-center justify-center gap-1 md:gap-2 px-4 py-4 mx-auto max-w-4xl">
